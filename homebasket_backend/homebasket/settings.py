"""
Django settings for homebasket project.
...
SECRET_KEY = 'django-insecure-15iiu_3qe5uppjm+itrk-9o9l2o6sq&xsj=@gwiq7$#+4h6c++'
...
WSGI_APPLICATION = 'homebasket.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config(
        ...
        conn_max_age=600,   # connection pool
    )
}
